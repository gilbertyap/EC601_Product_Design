...
# Modifications made by Gilbert Yap (2020) to run in EC601_Product_Design repo
# https://github.com/gilbertyap/EC601_Product_Design
...
import sys, shutil
sys.path.insert(1, '..\\SharedResources\\pyBK\\')
