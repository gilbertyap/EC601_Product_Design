...
if __name__ == "__main__":
    audioPath = '../../SharedResources/AudioFiles/Project3/'
    refRttmPath = '../../SharedResources/RttmFiles/Project3/Reference/'
    genRttmPath = '../../SharedResources/RttmFiles/Project3/Generated/'
    ...
    fileList = os.listdir('../../SharedResources/AudioFiles/Project3/')
    fileList.sort()
