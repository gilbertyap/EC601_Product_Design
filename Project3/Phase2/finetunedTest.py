...
SAD_PATH = './training/sad/train/VoxConverse.SpeakerDiarization.voxconverse.train/weights/0008.pt'
SCD_PATH = './training/scd/train/VoxConverse.SpeakerDiarization.voxconverse.train/weights/0009.pt'
REF_RTTM_PATH = '../../SharedResources/RttmFiles/Project3/Reference/'
GEN_RTTM_PATH = '../../SharedResources/RttmFiles/Project3/Generated/'
AUDIO_PATH = '../../SharedResources/AudioFiles/Project3/'
...
def diarizeFiles(fileList, pipeline, test_name):
    ...
    tempRttmFileList = os.listdir(REF_RTTM_PATH)
    finalRttmFileList = []
    for file in tempRttmFileList:
